/**
 * The single source of truth for Scribe's version history. Both the in-app
 * "What's new" panel (Settings) and the repo's CHANGELOG.md are generated from
 * this list, so there is only ever one place to update when a version ships.
 *
 * Versioning follows MAJOR.MINOR.PATCH:
 *  - MAJOR — big, direction-setting releases
 *  - MINOR — significant new features or changes
 *  - PATCH — small fixes and tweaks
 *
 * Newest version first. The first entry's `version` is the current version.
 */
...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    version: '1.6.3',
    date: '2026-07-10',
    title: 'Scrolling fixed during dictation & smarter model switching',
    changes: [
  ...
  },
  {
    version: '1.6.2',
    date: '2026-07-10',
    title: 'Double-tap fixes & update check up top',
    changes: [
  ...
  },
  {
    version: '1.6.1',
    date: '2026-07-10',
    title: 'The big one: themes, smarter models, update checks & a stack of fixes',
    changes: [
      ...
      'What\'s new (this panel) now groups updates by size — major, smaller, smallest — with release dates.'
    ]
  },
  {
    version: '0.6.0',
    date: '2026-07-07',
    title: 'Cleaner writing & a smarter dictionary',
    changes: [
  ...
  },
  {
    version: '0.5.0',
    date: '2026-07-07',
    title: 'A calmer, more professional look',
    changes: [
  ...
  },
  {
    version: '0.4.0',
    date: '2026-07-06',
    title: 'Tap-to-stop, redesigned overlay, monitor choice & debug console',
    changes: [
  ...
  },
  {
    version: '0.3.0',
    date: '2026-07-06',
    title: 'Double-tap shortcut, guided setup & performance stats',
    changes: [
  ...
  },
  {
    version: '0.2.5',
    date: '2026-07-06',
    title: 'Cleaner handling of unfinished sentences',
    changes: [
  ...
  },
  {
    version: '0.2.3',
    date: '2026-07-06',
    title: 'Fixed: dictation now records your voice',
    changes: [
  ...
  },
  {
    version: '0.2.2',
    date: '2026-07-06',
    title: 'Groundwork for the mic fix',
    changes: [
...
/** The current app version — the newest changelog entry. */
